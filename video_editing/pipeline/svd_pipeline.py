...
class StableVideoDiffusionPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        # image_embeddings = self._encode_image(image, device, num_videos_per_prompt, self.do_classifier_free_guidance)   # original implementation
        ...
        ## below is origial implementation
        ...
        # 4.1 prepare video latents
        # video_latent = self._encode_vae_image(
        #     frames,
        #     device=device,
        #     num_videos_per_prompt=num_videos_per_prompt,
        #     do_classifier_free_guidance=False
        ...
        # noise = torch.rand_like(video_latent)
        # noisy_video_latent = self.scheduler.add_noise(
        #     video_latent,
        #     noise,
        ...
        bboxes, masks = self.prepaer_boxes(bbox)
        bboxes = bboxes.unsqueeze(1).to(device)
        masks = masks.unsqueeze(1).to(device)
        
        # if self.do_classifier_free_guidance:
        #     bboxes = bboxes.repeat(2, 1, 1)
